    ...
    ///
    /// ## Accessibility
    /// - The title uses Dynamic Type and acts as a section header.
    /// - Annotations above bars are short and legible; consider adding explicit `accessibilityLabel`
    ///   on the mark if advanced VoiceOver output is needed.
    /// - Colors come from app tokens (`AppStyle`) to adapt well to Light/Dark modes.
    ///
